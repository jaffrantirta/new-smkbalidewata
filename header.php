        ...
        <div class="container">
            <div class="top-bar-content">
                <div class="social-links">
                    <?php
                    $instagram_url = get_theme_mod('smk_instagram_url', '#');
                    $facebook_url = get_theme_mod('smk_facebook_url', '#');
                    $youtube_url = get_theme_mod('smk_youtube_url', '#');
                    ?>
                    ...
                    <?php endif; ?>
                    <?php if ($youtube_url): ?>
                        <a href="<?php echo esc_url($youtube_url); ?>" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                ...
                <div class="contact-info">
                    <?php
                    $phone = get_theme_mod('smk_phone_number', '+6282227535136');
                    $email = get_theme_mod('smk_email', 'info@merdeka-tc.id');
                    ?>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="primaryNavbar">
                ...
                ?>
                <a href="<?php echo esc_url(get_theme_mod('smk_cta_url', '#daftar')); ?>" class="btn btn-cta ms-lg-3">
                    <?php echo esc_html(get_theme_mod('smk_cta_text', 'Ayo Daftar !')); ?>
                </a>
            </div>
        </div>
    </nav>
